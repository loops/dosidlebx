...
int_21h_fntable dw offset int_xxh_zerocount    ; FN 00h: Terminate.
                ...
                dw 04h dup (int_xxh_zerocount)  ; FNs 0dh - 10h
                dw 10h dup (int_xxh_zerocount)  ; FNs 11h - 20h.
                dw 09h dup (int_xxh_zerocount)  ; FNs 21h - 29h.
                dw offset int_xxh_skip         ;  FN 2Ah: Get Current Date
                dw 01h dup (int_xxh_zerocount)  ; FNs 2bh
                dw offset int_xxh_skip         ;  FN 2Ch: Get Time
                dw 04h dup (int_xxh_zerocount)  ; FNs 2dh - 30h.
...
msg_intro       db KERNEL_NAME, " V2.51  [Bld 0102BX]", NL
